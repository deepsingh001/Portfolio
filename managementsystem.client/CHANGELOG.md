...
- Create Angular project with ng: `ng new managementsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`managementsystem.client.esproj`).
